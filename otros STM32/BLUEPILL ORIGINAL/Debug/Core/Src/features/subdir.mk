...
clean-Core-2f-Src-2f-features:
	-$(RM) ./Core/Src/features/MPPT.cyclo ./Core/Src/features/MPPT.d ./Core/Src/features/MPPT.o ./Core/Src/features/MPPT.su ./Core/Src/features/alm_mem_flash.cyclo ./Core/Src/features/alm_mem_flash.d ./Core/Src/features/alm_mem_flash.o ./Core/Src/features/alm_mem_flash.su ./Core/Src/features/com_satelite.cyclo ./Core/Src/features/com_satelite.d ./Core/Src/features/com_satelite.o ./Core/Src/features/com_satelite.su ./Core/Src/features/temp_control.cyclo ./Core/Src/features/temp_control.d ./Core/Src/features/temp_control.o ./Core/Src/features/temp_control.su
