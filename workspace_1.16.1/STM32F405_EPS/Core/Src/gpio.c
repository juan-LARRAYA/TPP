...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, Enable3_3V_Pin|Enable5VBis_Pin|EnableCalefactor_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = Enable3_3V_Pin|Enable5VBis_Pin|EnableCalefactor_Pin;
